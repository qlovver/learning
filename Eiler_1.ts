...
function zadacha_12(): number {
    let treug:number = 0
    let count_del:number = 0
    for (let i: number = 7; i<=9999999; i++){
        for (let j:number = 1; j<=i; j++) {
            treug+=j
        }
        for (let delitel:number = 1; delitel <= (treug**0.5).toFixed(); delitel++){
            if (treug % delitel === 0){
                count_del+=2
            }
        }
...
function zadacha_14() : number {
    let nach:number = 1
    let chet:number = 0
    let max_chet:number = 0
    while (nach !== 1000000){
        nach++
        let chislo: number = nach
        while (chislo !== 1){
            if (chislo % 2 === 0) {
                chislo = chislo / 2
            }
...
function factorialo(n:number) : number {
    let a = 1
    for (let i = 2; i<=n; i++){
        a*=i;
    }
...
function zadacha_16() : number { // ????
    let chislo = 2**1000
    let strok = chislo.toString()
    let viv= 0
